      ...
      <div className="register-left">
        <div className="register-left-content">
          ...
          <p className="register-welcome-sub">
            Acesse seu painel para acompanhar os resultados e escalar suas estratégias de crescimento digital.
          </p>
      ...
      <div className="register-right">
        <form className="register-card" onSubmit={handleLogin}>
          <div className="register-card-header">
            <h2 className="register-card-title">FAZER LOGIN</h2>
            <p className="register-card-sub">Insira suas credenciais para acessar</p>
          </div>
          ...
          <div style={{ textAlign: 'center', marginTop: '1rem' }}>
            ...
            <Link to="/register" style={{ color: '#ff4d00', textDecoration: 'none', fontSize: '0.875rem', fontWeight: 500 }}>
              Criar conta
            </Link>
          </div>
