...
const Termos = () => {
  return (
    <PublicPageLayout title="Termos de Uso" description="Última atualização: Abril de 2026">
      ...
      <p>
        Ao acessar ou usar a plataforma Kortex (aplicativos, sites, integrações), você concorda em ficar vinculado 
        a estes Termos de Serviço e a todas as leis e regulamentos aplicáveis.
      </p>
      
      <h2>2. Licença de Uso</h2>
      <p>
        Concedemos a você uma licença limitada, não exclusiva e não transferível para acessar e usar a Plataforma Kortex 
      ...
      <p>
        A Kortex se esforça para manter uma disponibilidade de 99.9% de seus serviços. No entanto, não garantimos 
