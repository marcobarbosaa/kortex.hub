...
const Sobre = () => {
  return (
    <PublicPageLayout title="Sobre a Kortex" description="Estratégia, design e tecnologia combinados em um único sistema de crescimento.">
      ...
      <h2>Nossa Visão</h2>
      <p>
        Acreditamos que o crescimento sustentável requer uma fundação sólida, onde o design
        encontra a tecnologia e a estratégia de forma coesa e orientada por dados.
      </p>
    </PublicPageLayout>
  );
};
