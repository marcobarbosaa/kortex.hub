...
const Privacidade = () => {
  return (
    <PublicPageLayout title="Política de Privacidade" description="Última atualização: Abril de 2026">
      ...
      <p>
        A Kortex coleta as seguintes informações: dados de cadastro (nome, email, telefone), dados de navegação 
      ...
      <p>
        ...
        (cloud, gateways de pagamento) essenciais para o funcionamento da plataforma Kortex, sob rígidos acordos de confidencialidade.
      </p>
    </PublicPageLayout>
  );
};
